            ...
            >
                <div className="flex items-start justify-between gap-3 px-5 pt-5 pb-2">
                    <div className="flex items-center gap-2">
                        <AlertTriangle className="h-4 w-4 text-kd-accent" strokeWidth={1.5} />
                ...
                <div className="flex justify-end gap-2 px-5 pb-5 pt-3">
                    <button
                        onClick={onClose}
                        className="rounded-[10px] px-4 py-1.5 text-sm font-medium text-muted-foreground hover:bg-muted"
                    >
                        Cancel
                    </button>
                    <button
