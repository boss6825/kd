...
export function VersionChip({ n }: { n: number | null | undefined }) {
    ...
    return (
        <span className="shrink-0 inline-flex items-center rounded-md border border-border bg-card px-1 py-0.5 text-[10px] font-mono font-medium text-muted-foreground">
            V{n}
        </span>
    );
}
