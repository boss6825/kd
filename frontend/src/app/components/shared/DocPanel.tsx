...
export type DocPanelMode =
    | { kind: "document" }
    | { kind: "citation"; citation: KdCitationAnnotation }
    | {
          kind: "edit";
          edit: KdEditAnnotation;
          /**
                ...
                <div className="flex items-center justify-end gap-2 py-2">
                    <div className="mr-auto flex min-w-0 items-center gap-2">
                        ...
                        {versionNumber && versionNumber > 0 && (
                            <span className="shrink-0 inline-flex items-center rounded-md border border-border bg-card px-1.5 py-0.5 text-[10px] font-mono font-medium text-muted-foreground">
                                V{versionNumber}
                            </span>
                        )}
                    </div>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
    return <p className="kd-label text-muted-foreground">{children}</p>;
}
        ...
        <div className="pt-2 pb-3">
            ...
            <div className="w-full rounded-md bg-muted border border-border px-2 py-2">
                <div className="text-sm leading-relaxed font-serif">
                    {edit.inserted_text && (
                        <span className="text-kd-ok">
                            {edit.inserted_text}
                        </span>
                    )}
                    {edit.deleted_text && (
                        <span className="text-kd-danger line-through">
                            {edit.deleted_text}
                        </span>
                    )}
                </div>
    ...
    return (
        <div className="flex items-center gap-2">
            <button
                ...
                className="inline-flex items-center gap-1 rounded-lg border border-primary bg-primary px-2 py-1.5 text-xs font-medium text-primary-foreground hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
                ...
                disabled={inFlight || resolved}
                className="inline-flex items-center gap-1 rounded-lg border border-border bg-card px-2 py-1.5 text-xs font-medium text-foreground hover:bg-muted disabled:opacity-50 disabled:cursor-not-allowed"
            >
