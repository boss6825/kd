...
import { getWorkflow, updateWorkflow } from "@/app/lib/kdApi";
...
import type { ColumnConfig, KdWorkflow } from "@/app/components/shared/types";
import {
    BUILT_IN_IDS,
    BUILT_IN_WORKFLOWS,
...
export default function WorkflowDetailPage({ params }: Props) {
    ...
    const [workflow, setWorkflow] = useState<KdWorkflow | null>(null);
