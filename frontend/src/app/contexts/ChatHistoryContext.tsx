...
import type { KdChat, KdMessage } from "@/app/components/shared/types";
...
interface ChatHistoryContextType {
    ...
    newChatMessages: KdMessage[] | null;
    setNewChatMessages: (messages: KdMessage[] | null) => void;
    replaceChatId: (
        oldChatId: string,
        newChatId: string,
        title?: string,
...
export function ChatHistoryProvider({ children }: { children: ReactNode }) {
    const { user } = useAuth();
    const [chats, setChats] = useState<KdChat[] | null>(null);
